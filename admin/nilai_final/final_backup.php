				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<input type="number" placeholder="PBB Variasi" name="tn_pengurangan" id="tn_pengurangan" class="form-control">
						</div>
					</div>
				</div>
...
if (isset($_POST['simpan'])) {
	...
	if (!empty($errors)) {
		...
		$total_nilai = ((float)$tn_murni+(float)$tn_kreasi+(float)$tn_formasi+(float)$tn_variasi-(float)$tn_pengurangan);
